...
- `review-docs` owns CHANGELOG/ROADMAP same-commit discipline, README/title-card tone + Easter-egg non-leakage, and `.claude/**` + `ARCHITECTURE.md`/`DEBUGGING.md` consistency.
...
- Use `.claude/reviews/NNN-<scope-slug>/`.
...
| `review-docs` | `CHANGELOG.md`, `ROADMAP.md`, `README.md`, `ARCHITECTURE.md`, `DEBUGGING.md`, `CLAUDE.md`, `.claude/**` |
