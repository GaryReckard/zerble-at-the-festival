...
> **Status:** <!--STATUS:LINE-->in progress · 20/48 tasks (41%)<!--/STATUS:LINE-->
>
...
<!--STATUS:AUTO-->
**in progress** — 20/48 tasks complete (41%) · current: 7.3.1
...
| 7. Slice 4 — forest-tree instancing (the real draw lever) | 6/19 |
<!--/STATUS:AUTO-->
