...
> **Status:** <!--STATUS:LINE-->in progress · 14/48 tasks (29%)<!--/STATUS:LINE-->
>
...
<!--STATUS:AUTO-->
**in progress** — 14/48 tasks complete (29%) · current: 7.1.1
...
| 7. Slice 4 — forest-tree instancing (the real draw lever) | 0/19 |
<!--/STATUS:AUTO-->
